 ...
 */
class CarTransporter<T extends Car> extends Truck implements ICanLoadCars<T> {
    ...
    public BufferedImage getIcon() {
        try{return ImageIO.read(DrawPanel.class.getResourceAsStream("/pics/CarTransporter.jpg"));
